...
import "../chi/minter/ChiTimedMinter.sol";
import "../oracle/collateralization/ICollateralizationOracleWrapper.sol";

/// @title CollateralizationOracleKeeper
/// @notice a CHI timed minter which only rewards when updating the collateralization oracle
contract CollateralizationOracleKeeper is ChiTimedMinter {
    ...
    */
    ...
    ) ChiTimedMinter(_core, address(this), _incentive, MIN_MINT_FREQUENCY, 0) {
