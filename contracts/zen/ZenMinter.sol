...
contract ZenMinter is IZenMinter, RateLimited, Ownable {
    ...
    function setZenTreasury(address newZenTreasury) external override onlyGovernorOrAdmin {
    ...
    function setZenRewardsDripper(address newZenRewardsDripper) external override onlyGovernorOrAdmin {
