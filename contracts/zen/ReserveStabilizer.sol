...
/** 
  @title implementation for a Reserve Stabilizer Contract

  This contract will be the unique Reserve Stabilizer contract. 
...
*/
contract ReserveStabilizer is IReserveStabilizer, RateLimited, Ownable {
    ...
    function setAnnualMaxInflationBasisPoints(uint256 newAnnualMaxInflationBasisPoints) external override onlyGovernor {
