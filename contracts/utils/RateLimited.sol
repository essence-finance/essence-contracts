...
abstract contract RateLimited is CoreRef {
    ...
    function setRateLimitPerSecond(uint256 newRateLimitPerSecond) external virtual onlyGuardianOrGovernor {
    ...
    function setBufferCap(uint256 newBufferCap) external virtual onlyGuardianOrGovernor {
