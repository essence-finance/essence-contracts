...
contract PCVSentinel is IPCVSentinel, CoreRef, ReentrancyGuard {
     ...
     * @param _core the Essence core address
     */
     ...
     */
    function knight(address guard) external override hasAnyOfTwoRoles(ZenRoles.GUARDIAN, ZenRoles.GOVERNOR) {
        guards.add(guard);
     ...
     */
    function slay(address traitor) external override hasAnyOfTwoRoles(ZenRoles.GUARDIAN, ZenRoles.GOVERNOR) {
