...
*/
contract EssenceDAOTimelock is Timelock, CoreRef {
    address public constant OLD_TIMELOCK = 0x0000000000000000000000000000000000000000;
    ...
    function rollback() external onlyGuardianOrGovernor {
        require(block.timestamp <= ROLLBACK_DEADLINE, "EssenceDAOTimelock: rollback expired");

        IEssenceDAO(admin).updateTimelock(OLD_TIMELOCK);
    }
}

interface IEssenceDAO {
