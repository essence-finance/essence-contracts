...
import {ZenRoles} from "../../core/ZenRoles.sol";
    ...
    CoreRef
{
    ...
    constructor(ERC20VotesComp _zen, address _core)
        Governor("NopeDAO")
        GovernorSettings(
            0, /* 0 blocks */
    ...
    /// @notice Override of a Governor Settings function, to restrict to Zen GOVERNOR
    function setVotingDelay(uint256 newVotingDelay) public override onlyZenRole(ZenRoles.GOVERNOR) {
        _setVotingDelay(newVotingDelay);
    }

    /// @notice Override of a Governor Settings function, to restrict to Zen GOVERNOR
    function setVotingPeriod(uint256 newVotingPeriod) public override onlyZenRole(ZenRoles.GOVERNOR) {
        _setVotingPeriod(newVotingPeriod);
    }

    /// @notice Override of a Governor Settings function, to restrict to Zen GOVERNOR
    function setProposalThreshold(uint256 newProposalThreshold) public override onlyZenRole(ZenRoles.GOVERNOR) {
        _setProposalThreshold(newProposalThreshold);
    }

    /// @notice Adjust quorum of NopeDAO. Restricted to GOVERNOR, not part of GovernorSettings
    function setQuorum(uint256 newQuroum) public onlyZenRole(ZenRoles.GOVERNOR) {
