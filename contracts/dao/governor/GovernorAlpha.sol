...
contract GovernorAlpha {
    ...
    /// @notice The address of the Essence Finance Timelock
    TimelockInterface public timelock;

    /// @notice The address of the ZEN governance token
    ZenInterface public zen;
    ...
    function propose(
        ...
        require(
            zen.getPriorVotes(msg.sender, sub256(block.number, 1)) > proposalThreshold(),
    ...
    function cancel(uint256 proposalId) public {
        ...
        require(
            msg.sender == guardian ||
                zen.getPriorVotes(proposal.proposer, sub256(block.number, 1)) < proposalThreshold(),
    ...
    function _castVote(
        ...
        uint96 votes = zen.getPriorVotes(voter, proposal.startBlock);
